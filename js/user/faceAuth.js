    ...
    showModal: (onSuccess, onFailure) => {
        ...
        const modalHTML = `
            <div style="
                ...
                position: relative;
            ">
                <div style="font-size: 17px; font-weight: 700; letter-spacing: 0.5px; margin-bottom: 6px; color: #3b82f6; display:flex; align-items:center; justify-content:center; gap:8px;">
