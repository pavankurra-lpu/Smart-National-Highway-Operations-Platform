...
const LaneAdvisor = {
    ...
    renderAdvisor: (routeData, isSpecialVerified) => {
        ...
        lanes.forEach(l => {
            ...
            let borderCol = isSelected ? '#f2a93b' : (isRec ? 'var(--primary)' : 'var(--border-light)');
            let bgCol = isSelected ? 'rgba(242, 169, 59,0.16)' : (isRec ? 'rgba(0,229,179,0.1)' : 'rgba(0,0,0,0.25)');
                ...
                ">
                    <div style="flex:1; min-width:0;">
                        <div style="display:flex; align-items:center; gap:6px; margin-bottom:2px;">
                            ...
                            ${isSelected ? `<span style="font-size:8px; font-weight:800; background:#f2a93b; color:#000; padding:1px 5px; border-radius:3px;">SELECTED</span>` : ''}
                        </div>
                    ...
                    <div style="text-align:right; flex-shrink:0; display:flex; flex-direction:column; align-items:flex-end; gap:4px;">
                        ...
                        <button type="button" onclick="LaneAdvisor.selectLane('${l.laneNum}', '${plazaName}')" style="
                            ...
                            padding: 3px 8px;
                            border-radius: 4px;
                            border: 1px solid ${isSelected ? '#f2a93b' : 'rgba(255,255,255,0.15)'};
                            background: ${isSelected ? '#f2a93b' : 'rgba(255,255,255,0.06)'};
        ...
        return `
            ...
            <div style="background:linear-gradient(135deg, rgba(15,23,42,0.95), rgba(30,41,59,0.95)); border:1px solid rgba(255,255,255,0.1); border-radius:10px; padding:10px 12px; margin-bottom:12px;">
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; margin-top:8px; padding-top:6px; border-top:1px solid rgba(255,255,255,0.08); font-size:10px; color:#cbd5e1;">
                    ...
                    <span><i class="fa-solid fa-car-side" style="color:#f2a93b;"></i> Vehicle: <strong style="color:#fff;">${vType}</strong></span>
                </div>
            </div>
            ...
            ${(() => {
                ...
                const decColors = {
                    ...
                    'Recommend Monthly Pass': { border: '#a855f7', bg: 'rgba(168,85,247,0.12)', text: '#f2a93b', icon: 'fa-calendar-check' },
